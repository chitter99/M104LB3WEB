...
<article id="booking">
    ...
    <form action="" method="POST">
        ...
        <select class="book_form_select" name="title">
        ...
        <div>
          <lable for="surname">Vorname:
            <input class="book_form_name" type="text" name="surname" />
          </lable>
          <lable for="name">Nachname:
            <input class="book_form_name" type="text" name="name" />
          </lable>
        </div>
        <lable for="mail">Mail:
          <input class="book_form_name" type="text" name="mail" />
        </lable>
        <lable for="phone">Telefonnummer:
          <input class="book_form_name" type="text" name="phone" />
        </lable>
        <lable for="addresse">Adresse:
          <input class="book_form_name" type="text" name="address" />
        </lable>
        <lable for="birthday">Geburtstag:
          <input class="book_form_name" type="date" name="birthday" />
        </lable>
        <lable for="city">Stadt:
          <select class="book_form_select" name="city">
        ...
        <lable for="room">Room:
          <select class="book_form_select" name="room">
